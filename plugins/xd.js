...
m.reply(wait)
try {
  let res = await fetch(`https://xyroinee-apis.claraaaaaaa1909.repl.co/api/downloader/xnxx?url=${text}&apikey=5voHLfsgrX`)
  let json = await res.json()
  conn.sendMessage(m.chat, { video: { url: json.data.files.high }, caption: `Title: ${json.data.title}\nDuration: ${json.data.duration}\nInfo: ${json.data.info}` }, { quoted: m })
  } catch (e) {
